...
import data1 from './data/ClassificationUMAP/1.json';
import data2 from './data/ClassificationUMAP/2.json';
import data3 from './data/ClassificationUMAP/3.json';
...
const ClassificationUMAP = () => {
  ...
  const processedData3 = useMemo(() => {
    ...
    return data3.data_list.map(item => ({
      x: parseFloat(item.UMAP_1),
      y: parseFloat(item.UMAP_2),
  ...
  const tableColumns3 = [
    ...
    { title: 'UMAP_1', dataIndex: 'UMAP_1', key: 'UMAP_1', width: 100, sorter: (a, b) => parseFloat(a.UMAP_1) - parseFloat(b.UMAP_1) },
    { title: 'UMAP_2', dataIndex: 'UMAP_2', key: 'UMAP_2', width: 100, sorter: (a, b) => parseFloat(a.UMAP_2) - parseFloat(b.UMAP_2) },
  ...
  return (
    <PageTemplate pageTitle="分类UMAP图">
      <Tabs
        activeKey={activeTab}
